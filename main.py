...
percentage_bachelors = round((float(((df['education'] == 'Bachelors').sum()) / df.shape[0])*100), 1)
...
rich_percentage = float(len(num_min_workers[num_min_workers["salary"]==">50K"])/len(num_min_workers)*100)
